...
export function renderSummaryView({ metrics, elements }) {
  if (!metrics) {
...
export function updateSummaryProgressView({ completion, label, elements }) {
  const percent =
...
export function updateDailyAverageView({ averageValue, daysWithData, isCurrentMonth, elements }) {
...
export function updateContractCardView({ contractMetrics, elements, formatMoneyFn = formatMoney, formatPercentFn = formatPercent }) {
  ...
  updateContractProgressView({ completion, elements });
}

export function updateContractProgressView({ completion, elements }) {
