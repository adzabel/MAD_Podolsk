// Copied from docs/js/components.js for Vite bundle
import {
  formatMoney,
  formatPercent,
  formatMoneyRub,
...
// Due to length, full implementation is kept identical to docs/js/components.js
// to preserve layout and behaviour.
// BEGIN: UIManager implementation (unchanged copy)
